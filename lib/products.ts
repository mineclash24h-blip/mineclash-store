export const ranks = [
  { id: 6, name: 'CLASH+', category: 'ranks', priceUSD: 8.36, priceINR: 690, image: '/images/clash+.jpg', description: `Purchasing this rank grants you access to all of the features below:\n\nAccess to /sit\nAccess to /lay\nAccess to /smitingtable\nAccess to /stonecutter\nAccess to /enderchest\nAccess to /workbench\nAccess to /repair\nAccess to /anvil\nAccess to /hat\n\nCreate up to 12x Set Homes\nCreate up to 14 Auctions listing\nAccess up to 17 Vault\nAccess up to 20 Orders` },
  { id: 7, name: 'CLASH', category: 'ranks', priceUSD: 5.21, priceINR: 430, image: '/images/clash.jpg', description: `Purchasing this rank grants you access to all of the features below:\n\nAccess to /sit\nAccess to /lay\nAccess to /smitingtable\nAccess to /enderchest\nAccess to /stonecutter\nAccess to /anvil\nAccess to /hat\n\nCreate up to 9x Set Homes\nCreate up to 8 Auctions listing\nAccess up to 13 Vault\nAccess up to 15 Orders` },
